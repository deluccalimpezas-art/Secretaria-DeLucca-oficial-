                        ...
                        <div className="flex items-center gap-1">
                            ...
                            {isExpanded ? (
                                <input
                                    ...
                                    className="bg-transparent border-none outline-none focus:ring-1 focus:ring-indigo-500 rounded px-2 py-0.5 w-full text-indigo-400 font-bold text-sm cursor-text"
                                    placeholder="Valor"
                                />
                            ) : (
                                <input
                                    ...
                                    readOnly
                                    className="bg-transparent border-none outline-none focus:ring-1 focus:ring-indigo-500 rounded px-2 py-0.5 w-full text-indigo-400 font-bold text-sm cursor-pointer"
                                />
                            )}
                        </div>
                    </div>
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            {isExpanded ? (
                                <input
                                    ...
                                    className="bg-transparent border-none outline-none focus:ring-1 focus:ring-blue-500 rounded px-2 py-0.5 w-full text-blue-400 font-bold text-sm cursor-text"
                                    placeholder="Salário"
                                />
                            ) : (
                                <input
                                    ...
                                    readOnly
                                    className="bg-transparent border-none outline-none focus:ring-1 focus:ring-blue-500 rounded px-2 py-0.5 w-full text-blue-400 font-bold text-sm cursor-pointer"
                                />
                            )}
                        </div>
                    </div>
